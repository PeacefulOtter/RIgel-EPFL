...
public final class HorizontalCoordinates extends SphericalCoordinates
{
    ...
    /**
     * Check if the coordinates are in their intervals
     * @param az : azimut (longitude)
     * @param alt : altitude (latitude)
     */
    private static void checkIntervals( double az, double alt )
    {
